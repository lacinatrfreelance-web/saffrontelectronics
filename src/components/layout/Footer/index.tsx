    ...
    <footer className="bg-gray-950 relative overflow-hidden">
      ...
      <div className="border-b border-white/5">
        ...
        >
          <motion.div variants={itemVariants} className="max-w-lg">
            <p className="text-xs font-bold text-orange-400 uppercase tracking-[0.2em] mb-3">Toujours disponible</p>
            <h2 className="text-3xl md:text-4xl font-black text-white leading-tight">
              Votre projet electromenager<br />
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-3">
            ...
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
              ...
              >
                Nous ecrire <ArrowUpRight size={14} />
              </Link>
            </motion.div>
          </motion.div>
        </motion.div>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="lg:col-span-1">
          ...
          <p className="text-sm text-white/40 leading-relaxed mb-6">
            Specialiste en electromenager a Abidjan depuis plus de 10 ans. Qualite garantie, service exceptionnel.
          </p>
          <a
        ...
        <motion.div variants={itemVariants}>
          <h4 className="text-xs font-black text-white/30 uppercase tracking-[0.2em] mb-6">Navigation</h4>
            ...
            {NAV_COL.map((link) => (
              <li key={link.to}>
                ...
                >
                  ...
                  <span className="-translate-x-2 group-hover:translate-x-0 transition-transform duration-200">{link.label}</span>
                </Link>
              </li>
            ))}
          </ul>
        ...
        {/* Contact */}
        <motion.div variants={itemVariants}>
          <h4 className="text-xs font-black text-white/30 uppercase tracking-[0.2em] mb-6">Contact</h4>
        ...
        {/* Hours */}
        <motion.div variants={itemVariants}>
          <h4 className="text-xs font-black text-white/30 uppercase tracking-[0.2em] mb-6">Horaires</h4>
          <div className="space-y-3 mb-6">
            {[
              { day: 'Lun — Sam', hours: '8h00 — 19h00' },
              ...
              <div key={day} className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-semibold text-white/60">{day}</p>
          ...
          <div className="inline-flex items-center gap-2.5 px-4 py-2.5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
            ...
            <span className="text-xs font-semibold text-emerald-400">Ouvert maintenant</span>
          </div>
        </motion.div>
      </motion.div>
      ...
      <div className="border-t border-white/5">
        <div className="container-custom py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/20">&copy; {year} Saffron Electronics CI — Tous droits reserves.</p>
          <p className="text-xs text-white/15">Abidjan, Cote d'Ivoire</p>
        </div>
      </div>
    </footer>
  )
